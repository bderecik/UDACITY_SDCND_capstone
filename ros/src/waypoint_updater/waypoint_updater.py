...
class WaypointUpdater(object):
    ...
    def decelerate_waypoints(self, waypoints, closest_idx):
        temp = []
        stop_idx = max(self.stopline_wp_idx - closest_idx - 4, 0) # Front location of car do not pass stop line using 4 waypoints back from stop line.
    ...
    def traffic_cb(self, msg):
        #Implementation of Callback for /traffic_waypoint message. 
